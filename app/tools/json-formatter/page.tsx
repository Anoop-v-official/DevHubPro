  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-xl text-gray-600 mb-8">Format, validate, and beautify JSON data</p>

        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <label className="block font-semibold text-gray-900 mb-2">Input JSON</label>
            <textarea
              value={input}
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full h-96 p-4 border-2 border-gray-300 rounded-lg font-mono text-sm bg-gray-50"
            />
            {error && (
